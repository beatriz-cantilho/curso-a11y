...
import RocketseatLogo from "../assets/img/rocketseat-logo.svg"
  ...
  return (
    ...
    <Head>
      ...
      <header className={styles.header}>
        <Image src={RocketseatLogo} width={286 / 2} alt="Blog da Rocketseat"/>

        <div className={styles.nav}>
          <a href="https://github.com/beatriz-cantilho">
